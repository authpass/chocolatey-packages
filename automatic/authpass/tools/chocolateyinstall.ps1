...
$url        = 'https://data.authpass.app/data/artifacts/AuthPass-setup-1.7.2_1333.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'authpass*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  # MSI
  silentArgs    = "/SILENT /SP- /NOICONS" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
